...
<div class="content">
    ...
    <div class="main_idea">
        HTML stands for Hyper Text Markup Language, which is what defines most web pages.  HTML is made up of the following...  Text content shows what you see.  Markup shows what your page will look like.  References to other documents, such as images are possible.  Links to other web pages are possible too.
...
<div class="content">
    ...
    <div class="main_idea">
        Tags can be either inline or block.  Inline tags examples are break, bold, emphasis, void tags, new lines, etc.  Block tags create an invisible block around the content.  Examples of this is paragraph and div
    </div>
</div>
>>> 
